...
#elif defined(FIRMWARE_4_30) || defined (FIRMWARE_4_75) || defined(FIRMWARE_4_75DEX)
	// Drm patches
	{ psp_drm_patch5, MAKE_JUMP_VALUE(psp_drm_patch5, psp_drm_patch6), &condition_psp_iso },
	{ psp_drm_patch7, LI(R6, 0), &condition_psp_iso },
	{ psp_drm_patch8, LI(R7, 0), &condition_psp_iso },
...
#if defined(FIRMWARE_4_30) || defined(FIRMWARE_4_75) || defined(FIRMWARE_4_75DEX)
...
#if defined(FIRMWARE_4_30) || defined (FIRMWARE_4_75)
