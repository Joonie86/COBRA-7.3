...
#elif defined(FIRMWARE_4_70) // As of 3/08/2015

#if defined(PS2HWEMU)

#define TOC					0x4EB8C0 //done

#define cdvd_send_atapi_command_symbol		0x22138 //done

#define ufs_open_symbol				0x4E0A8 //done
#define ufs_close_symbol			0x4E834 //done
#define ufs_read_symbol				0x4DB78 //done
...
#elif defined(PS2GXEMU) //As of 3/08/2014
