...
#if defined(FIRMWARE_4_78DEH)  // Ported by Joonie as of 1/20/2016 

#define VSH_CEX_HASH			0xa001da9d002e6f2c // Jooni3's ,
#define BDP_DISC_CHECK_PLUGIN_HASH	0xb8b7a5f9000031a0 // same as 4.66
#define BASIC_PLUGINS_HASH		0xb5988e42000201f1 // // same as 4.75  
#define EXPLORE_PLUGIN_HASH		0xacf4af2b000ec414 // Jooni3's
#define EXPLORE_CATEGORY_GAME_HASH	0x9cb378e600056ae1 // same as 4.75  
...
// 4.78 DEH's Offsets
#define cex_vsh_text_size		0x6C0000 // /* memsz of first program header aligned to 0x10000 */
#define cex_ps2tonet_patch		0xC9578 // 4.66CEX =0xC4C24 // "60638202 480000444BFF"
#define cex_ps2tonet_size_patch 	0xC956C // 4.66CEX = 0xC4C18 // "38A004F0786400203860000060638202"
#define cex_psp_drm_patch1		0x24CB14 // 0x24277C // 
#define cex_psp_drm_patch2		0x24D5B4 // 0x24321C // 
#define cex_psp_drm_patch3		0x24D1F0 // 0x242E58 // 
#define cex_psp_drm_patch4		0x24D9FC // 0x243664 // 
#define cex_psp_drm_patchA		0x24CC30 // 0x242898 // 
#define cex_psp_drm_patchB		0x24D4D0 // 0x243138 // 
#define cex_psp_drm_patchC		0x24C668 // 0x2422D0 // 
#define cex_psp_drm_patchD		0x24CC18 // 0x242880 //
#define cex_psp_drm_patchE		0x24CC1C // 0x242884 //
#define cex_psp_drm_patchF		0x24D5E8 // 0x243250 // 
#define cex_vmode_patch_offset		0x44D0C8 //0x445BEC // 

/* PSP PKG 80029537 error fix */
//#define cex_psp_newdrm_patch            0x24F14C // li %r3, 0
 
/* basic_plugins */// 4.76 CEX
#define ps1emu_type_check_offset	0x2028C // CEX Disabled by default
#define pspemu_path_offset		0x4BD58 // CEX "Search /dev_bdvd/PS3_GM01"
#define psptrans_path_offset		0x4C9C0 // CEX "Search aDev_flashPsp_1:.string "/dev_flash/pspemu/psp_translator.self"

/* explore_plugin */// 4.76 CEX
//#define app_home_offset			0x250B90 // CEX  *aApp_homePs3_ga:.string "/app_home/PS3_GAME"* // Disabled by default
#define ps2_nonbw_offset       0xDD9B4 // 0xDD97C	// CEX *aStoragemedi_25@h # "StorageMedia:StorageMedia.hybrid"*

/* explore_category_game */// 4.76 CEX
#define ps2_nonbw_offset2		0x68324 // CEX lis	 *r4, aStoragemedia_4@ha # "StorageMedia:StorageMedia.hybrid"*

/* bdp_disccheck_plugin */ //  the same as 4.46 - 4.76
#define dvd_video_region_check_offset	0x152C // 

/* ps1_emu */ // the same as 4.66 - 4.76
#define ps1_emu_get_region_offset	0x3E74 // 

/* ps1_netemu */ // the same as 4.66 - 4.76
#define ps1_netemu_get_region_offset	0xA440C // 

/* game_ext_plugin */// 4.76 CEX
...
/* emulator_api */ // the same as 4.66 - 4.76
...
/* libfs (external */ // The same as 4.55 - 4.76
