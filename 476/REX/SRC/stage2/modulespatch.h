...
#if defined(FIRMWARE_4_76) || defined(FIRMWARE_4_76DEX) // Ported by Joonie as of 9/3/2015 

#define VSH_DEX_HASH			0xa001d571002e50d7 //
#define VSH_CEX_HASH			0xa002a1ae002e1bb3 // 
