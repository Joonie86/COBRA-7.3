...
#if defined(FIRMWARE_4_81DEH)  // Ported by Joonie as of 1/20/2016 

#define VSH_DECR_HASH			0xa001f779002e7cb7 // Jooni3's ,
#define VSH_DECR_RBG_HASH		0xa001f779002e7cb6 // Jooni3's ,
#define VSH_DEX_HASH			0xa0000101002e3df4 // REX 4.81
#define BDP_DISC_CHECK_PLUGIN_HASH	0xb8b7a5f9000031a0 // REX 4.81
#define EXPLORE_PLUGIN_HASH		0xacf4af2b000ecc8f // REX 4.81
#define EXPLORE_CATEGORY_GAME_HASH	0x9cb3396e00056ce9 // REX 4.81
#define PS1_EMU_HASH			0x7a6cb5c70009afe8 // REX 4.81
#define PS1_NETEMU_HASH 		0x7a304962000be867 // REX 4.81
#define GAME_EXT_PLUGIN_HASH		0xe274af7b0001e5d3 //
#define PSP_EMULATOR_HASH		0x7be641f500023794 // REX 4.81
#define PEMUCORELIB_HASH		0xf349a563000c0d67 // REX 4.81
#define EMULATOR_API_HASH		0xa9f5b37a0001bb45 // REX 4.81
#define EMULATOR_DRM_HASH		0xa324dc4a00005399 // REX 4.81
#define EMULATOR_DRM_DATA_HASH		0x75c390860001b75f // REX 4.81
#define LIBSYSUTIL_SAVEDATA_PSP_HASH	0x57bbc3b800003212 //  REX 4.81
#define LIBFS_EXTERNAL_HASH		0x5bc7bce800006477 // REX 4.81


/* vsh */ // REBUG LITE 4.81.1 as of 1/20/2016
...
#define decr_vmode_patch_offset		0x44D444 //
...
/* explore_category_game */// 4.78 - 4.81 DEX
...
/* game_ext_plugin */// the same as DEX 4.81
#define sfo_check_offset		0x23ED0 // DEX *lis	  r3, aPage_game_ma_1@ha # "page_game_main"*
#define ps2_nonbw_offset3		0x17004 // DEX *rlwinm	  r0, r0, 0,26,26*
#define ps_region_error_offset		0x68C4 // DEX  
