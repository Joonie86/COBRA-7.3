...
{
	{ decr_psp_drm_patch1, LI(R3, 0) 	},
	{ decr_psp_drm_patch2, LI(R3, 0) 	},
	{ decr_psp_drm_patch3, LI(R3, 0) 	},
	{ decr_psp_drm_patch4, LI(R0, 0) 	},
	{ decr_psp_drm_patchA, LI(R0, 0) 	},
	{ decr_psp_drm_patchB, LI(R31, 0) 	},
	{ decr_psp_drm_patchC, LI(R3, 0) 	},	
	{ decr_psp_drm_patchD, NOP 		},
	{ decr_psp_drm_patchE, LI(R3, 0) 	},
	{ decr_psp_drm_patchF, LI(R3, 0) 	},
	{ 0 }
};
...
int sys_psp_set_umdfile(char *file, char *id, int prometheus)
{
	...
	if (!patches_backup)
	{
		switch(vsh_check)
		{
			case VSH_DECR_HASH:
				#ifdef DEBUG
				DPRINTF("Now patching PSP DRM In DECR VSH..\n");	
				#endif
