...
#elif defined(FIRMWARE_4_30) || defined (FIRMWARE_4_75) || defined(FIRMWARE_4_75DEX) || defined (FIRMWARE_4_80) || defined(FIRMWARE_4_80DEX) || defined (FIRMWARE_4_81) || defined(FIRMWARE_4_81DEX)
	// Drm patches
	{ psp_drm_patch5, MAKE_JUMP_VALUE(psp_drm_patch5, psp_drm_patch6), &condition_psp_iso },
	{ psp_drm_patch7, LI(R6, 0), &condition_psp_iso },
	{ psp_drm_patch8, LI(R7, 0), &condition_psp_iso },
...
#if defined(FIRMWARE_4_30) || defined (FIRMWARE_4_75) || defined (FIRMWARE_4_76) || defined (FIRMWARE_4_78) || defined (FIRMWARE_4_80) || defined (FIRMWARE_4_81)
...
#elif defined (FIRMWARE_4_75DEX) || defined (FIRMWARE_4_76DEX) || defined (FIRMWARE_4_78DEX) || defined (FIRMWARE_4_80DEX) || defined (FIRMWARE_4_81DEX)
LV2_HOOKED_FUNCTION_COND_POSTCALL_2(int, pre_modules_verification, (uint32_t *ret, uint32_t error))
{
