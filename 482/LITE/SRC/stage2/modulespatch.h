...
//REBUG REX 4.82.2 as of 11/30/2017 , COBRA 7.54
#elif defined(FIRMWARE_4_82) || defined(FIRMWARE_4_82DEX) // 

//#define VSH_DEX_HASH					0xb6b6d000002e4000 // STATIC HASH, COBRA 7.5
#define VSH_CEX_HASH					0xb6b6d000002e3000 // STATIC HASH, COBRA 7.5
#define BDP_DISC_CHECK_PLUGIN_HASH  	0x9940000000003000 // STATIC HASH, COBRA 7.5, 4.53-4.82
//#define BASIC_PLUGINS_HASH			0x55f470000001f000 // STATIC HASH, COBRA 7.5
#define EXPLORE_PLUGIN_HASH				0xc50d0000000ec000 // STATIC HASH, COBRA 7.5, 4.53-4.82
#define EXPLORE_CATEGORY_GAME_HASH		0xde52d00000056000 // STATIC HASH, COBRA 7.5, 4.53-4.82
#define PS1_EMU_HASH     				0xcc2840000009b000 // STATIC HASH, COBRA 7.5, 4.53-4.82
#define PS1_NETEMU_HASH     			0xcc284000000be000 // STATIC HASH, COBRA 7.5
#define GAME_EXT_PLUGIN_HASH			0xcc2680000001e000 // STATIC HASH, COBRA 7.5, 4.53-4.82
#define PSP_EMULATOR_HASH    			0xcc29b00000023000 // STATIC HASH, COBRA 7.5, 4.53-4.82
#define PEMUCORELIB_HASH    			0x40425000000c0000 // STATIC HASH, COBRA 7.5, 4.53-4.82
#define EMULATOR_API_HASH    			0x8409f0000001b000 // STATIC HASH, COBRA 7.5, 4.53-4.82
#define EMULATOR_DRM_HASH    			0xbbb8800000005000 // STATIC HASH, COBRA 7.5, 4.53-4.82
#define EMULATOR_DRM_DATA_HASH   		0x2f3ab0000001b000 // STATIC HASH, COBRA 7.5
#define LIBSYSUTIL_SAVEDATA_PSP_HASH	0x0dfdc00000003000 // STATIC HASH, COBRA 7.5, 4.53-4.82
#define LIBFS_EXTERNAL_HASH    			0x05fd000000006000 // STATIC HASH, COBRA 7.5, 4.53-4.82
...
/* explore_plugin */// 4.82 CEX
#define app_home_offset		0x250910 //*aApp_homePs3_ga:.string "/app_home/PS3_GAME"* 
#define ps2_nonbw_offset       0xDD9B4	// CEX *aStoragemedi_25@h # "StorageMedia:StorageMedia.hybrid"*

/* explore_category_game */// 4.78 - 4.82 CEX
...
/* psp_emulator */ //  4.82 CEX 
#define psp_set_psp_mode_offset 	0x1C18 // the same as 4.70

/* emulator_api */ // the same as 4.66 - 4.82
#define psp_read			0x102D8 //
#define psp_read_header			0x1125C //
#define psp_drm_patch5			0x11080 //
#define psp_drm_patch6			0x110B0 //
