...
{
/* NO longer used due to built-in fself patches in the FW	
#if defined (FIRMWARE_4_75DEX) || defined (FIRMWARE_4_81DEX)
...
#elif defined(FIRMWARE_4_30) || defined (FIRMWARE_4_75) || defined(FIRMWARE_4_75DEX) || defined (FIRMWARE_4_80) || defined(FIRMWARE_4_80DEX) || defined (FIRMWARE_4_82) || defined(FIRMWARE_4_82DEX)
	// Drm patches
	{ psp_drm_patch5, MAKE_JUMP_VALUE(psp_drm_patch5, psp_drm_patch6), &condition_psp_iso },
	{ psp_drm_patch7, LI(R6, 0), &condition_psp_iso },
	{ psp_drm_patch8, LI(R7, 0), &condition_psp_iso },
...
/* #if defined(FIRMWARE_4_30) || defined(FIRMWARE_4_75) || defined(FIRMWARE_4_75DEX) || defined(FIRMWARE_4_80) || defined(FIRMWARE_4_80DEX) || defined(FIRMWARE_4_82) || defined(FIRMWARE_4_82DEX)
...
{
		if(!strcmp(name, "vsh.self.cexsp"))
		{
			return VSH_CEX_HASH;
		}
		
		if(!strcmp(name, "vsh.self.dexsp"))
		{
			return VSH_DEX_HASH;
		}
...
#if defined(FIRMWARE_4_30) || defined (FIRMWARE_4_75) || defined (FIRMWARE_4_76) || defined (FIRMWARE_4_78) || defined (FIRMWARE_4_80) || defined (FIRMWARE_4_82)
...
#elif defined (FIRMWARE_4_75DEX) || defined (FIRMWARE_4_76DEX) || defined (FIRMWARE_4_78DEX) || defined (FIRMWARE_4_80DEX) || defined (FIRMWARE_4_82DEX)
LV2_HOOKED_FUNCTION_COND_POSTCALL_2(int, pre_modules_verification, (uint32_t *ret, uint32_t error))
{
